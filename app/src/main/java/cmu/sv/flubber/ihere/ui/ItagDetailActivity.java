 ...
 */
public class ItagDetailActivity extends AppCompatActivity {
...
/*
        if (savedInstanceState == null) {
            ...
            arguments.putString(ItagDetailFragment.ARG_ITEM_ID,
                    getIntent().getStringExtra(ItagDetailFragment.ARG_ITEM_ID));
